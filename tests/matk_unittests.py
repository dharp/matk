...
class Tests(unittest.TestCase):
    ...
    def testemcee(self):
        ...
        samples,lklhd = self.m.emcee(nwalkers=100, nsamples=1000, burnin=100)
    ...
    def testemcee2(self):
        ...
        #print lnprob([2., 5., 10.])
        #print lnprob([2., 8., 10.])
        samples,lklhd = self.m.emcee(lnprob=matk.logposteriorwithvariance(self.m), nwalkers=10, nsamples=10000, burnin=1000, pos0=pos0)
        #print samples.shape
