...
Template file used by :func:`pest_io.tpl_write <matk.pest_io.tpl_write>`. Note the header **ptf %** and parameter location **%por0%**. This example illustrates how to use an external simulator and other files required to run this example are not included.
